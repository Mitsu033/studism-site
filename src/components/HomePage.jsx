        ...
        <div className="container mx-auto px-8 md:px-12 lg:px-16 xl:px-20 py-4">
          <div className="flex items-center justify-between">
            ...
            <nav className="hidden md:flex space-x-6">
              <a href="#about" className="font-semibold text-foreground hover:text-primary py-2 border-b-2 border-transparent hover:border-primary transition-all">会社について</a>
              <a href="#apps" className="font-semibold text-foreground hover:text-primary py-2 border-b-2 border-transparent hover:border-primary transition-all">アプリ一覧</a>
              <a href="#news" className="font-semibold text-foreground hover:text-primary py-2 border-b-2 border-transparent hover:border-primary transition-all">お知らせ</a>
              <Link to="/contact" className="font-semibold text-foreground hover:text-primary py-2 border-b-2 border-transparent hover:border-primary transition-all">お問い合わせ</Link>
            </nav>
          </div>
        </div>
      </header>
